...
#Program to calculate mu1' and mu2' spectra through iteration.

#declare wavelength range (380-540 nm)
#Waves = numpy.arange(380, 541)
Waves = numpy.linspace(410, 500, 91)
...
# High Dose Rate
         # 380-409
         # [1.74306, 1.73000, 1.71161, 1.68587, 1.65218, 1.60740, 1.55149, 1.48450, 1.40645, 1.32067, 1.22510, 1.12603, 
         #  1.02467, 0.92212, 0.82209, 0.72258, 0.62771, 0.53925, 0.45767, 0.38389, 0.31823, 0.26100, 0.21207, 0.17116, 
         #  0.13753, 0.11055, 0.08911, 0.07247, 0.05978, 0.05009, 
         
Mueff4  = [0.04285, 0.03744, 0.03337, 0.03031, 0.02788, 0.02603, 0.02438, 0.02315, 0.02205, 0.02116, 0.02038, 0.01956, 
           0.01878, 0.01813, 0.01754, 0.01710, 0.01650, 0.01599, 0.01552, 0.01515, 0.01466, 0.01429, 0.01398, 0.01365, 
           0.01335, 0.01303, 0.01278, 0.01251, 0.01224, 0.01195, 0.01178, 0.01146, 0.01124, 0.01100, 0.01079, 0.01062, 
           0.01042, 0.01022, 0.01005, 0.00984, 0.00957, 0.00940, 0.00930, 0.00909, 0.00896, 0.00880, 0.00860, 0.00846, 
           0.00827, 0.00815, 0.00799, 0.00784, 0.00767, 0.00762, 0.00741, 0.00721, 0.00708, 0.00692, 0.00688, 0.00677, 
           0.00663, 0.00656, 0.00650, 0.00645, 0.00633, 0.00619, 0.00605, 0.00594, 0.00586, 0.00577, 0.00576, 0.00560, 
           0.00548, 0.00543, 0.00541, 0.00530, 0.00525, 0.00519, 0.00513, 0.00498, 0.00492, 0.00482, 0.00473, 0.00465,
           0.00452, 0.00454, 0.00441, 0.00442, 0.00436, 0.00429, 0.00424] 

          # 501 - 540
          # 0.O0420, 0.00417, 0.00413, 0.00404, 0.00398, 0.00389, 0.00386, 0.00380, 0.00376, 0.00373, 0.00365, 
...
#**********************************************************************************************************************
          ...
          # 380 - 409
          # [1.18534, 1.18280, 1.18097, 1.17848, 1.17191, 1.16189, 1.14847, 1.12597, 1.09322, 1.04957, 0.99112, 0.92293, 
          #  0.84679, 0.76635, 0.68468, 0.60385, 0.52584, 0.45226, 0.38439, 0.32283, 0.26812, 0.22027, 0.17954, 0.14537, 
          #  0.11720, 0.09457, 0.07659, 0.06253, 0.05181, 0.04367

Mueff6  = [0.03748, 0.03283, 0.02940, 0.02675, 0.02463, 0.02296, 0.02159, 0.02052, 0.01954, 0.01870, 0.01802, 0.01721, 
           0.01662, 0.01591, 0.01535, 0.01488, 0.01434, 0.01386, 0.01345, 0.01302, 0.01264, 0.01231, 0.01197, 0.01166, 
           0.01139, 0.01108, 0.01082, 0.01060, 0.01034, 0.01007, 0.00985, 0.00962, 0.00941, 0.00919, 0.00896, 0.00877, 
           0.00862, 0.00838, 0.00819, 0.00804, 0.00784, 0.00764, 0.00749, 0.00732, 0.00719, 0.00702, 0.00681, 0.00669, 
           0.00655, 0.00644, 0.00624, 0.00612, 0.00599, 0.00585, 0.00574, 0.00558, 0.00537, 0.00529, 0.00518, 0.00509, 
           0.00499, 0.00491, 0.00486, 0.00485, 0.00477, 0.00465, 0.00455, 0.00447, 0.00438, 0.00428, 0.00422, 0.00414, 
           0.00403, 0.00395, 0.00388, 0.00379, 0.00371, 0.00365, 0.00355, 0.00347, 0.00342, 0.00329, 0.00324, 0.00317, 
           0.00308, 0.00302, 0.00296, 0.00292, 0.00284, 0.00277, 0.00271]

           # 501 - 540
           # 0.00267, 0.00259, 0.00253, 0.00252, 0.00244, 0.00239, 0.00232, 0.00227, 0.00221, 0.00220, 0.00214, 
          ...
          # 380 - 409
          # [0.7184420, 0.7185922, 0.7177067, 0.7174141, 0.7174141, 0.7171215, 0.7165363, 0.7150964, 0.7131136, 0.7081894, 
...
#Mueff10 = [0.0065254, 0.0064094, 0.0062281, 0.0060346, 0.0058723, 0.0057010, 0.0055448, 0.0053678, 0.0052175, 0.0050676, 
...
#           0.0011134]
           ...
           # 501 - 540
           # 0.0010539, 0.0010234, 0.0009969, 0.0009698, 0.0009411, 0.0009024, 0.0008695, 0.0008580, 0.0008300, 
...
# Three Parameters Calculated From Low Dose

Znot = [2.46273, 2.46326, 2.46254, 2.46161, 2.45929, 2.45842, 2.45938, 2.45397, 2.45227, 2.45456, 2.45461, 2.45348, 2.44601, 
        2.44931, 2.45371, 2.44987, 2.45127, 2.45215, 2.45167, 2.45455, 2.45435, 2.45087, 2.45070, 2.44811, 2.45370, 2.45451, 
        2.45756, 2.45759, 2.45974, 2.46043, 2.46036, 2.45878, 2.45883, 2.46022, 2.45959, 2.46175, 2.46148, 2.46084, 2.46218, 
        2.46173, 2.46280, 2.46269, 2.46327, 2.46321, 2.46280, 2.46328, 2.46328, 2.46315, 2.46316, 2.46316, 2.46285, 2.46313, 
        2.46304, 2.46310, 2.46318, 2.46302, 2.46325, 2.46321, 2.46327, 2.46326, 2.46288, 2.46322, 2.46285, 2.46279, 2.46298, 
        2.46281, 2.46298, 2.46247, 2.46200, 2.46195, 2.45991, 2.46270, 2.46038, 2.46055, 2.45824, 2.46130, 2.45974, 2.45891, 
        2.45659, 2.45763, 2.45684, 2.45154, 2.45264, 2.45290, 2.45279, 2.44729, 2.44894, 2.45018, 2.45052, 2.44701, 2.44696]
 
Mu2 = [0.01465, 0.01231, 0.01096, 0.00962, 0.00871, 0.00796, 0.00692, 0.00668, 0.00645, 0.00599, 0.00545, 0.00517, 0.00523, 
       0.00489, 0.00430, 0.00429, 0.00384, 0.00355, 0.00346, 0.00326, 0.00311, 0.00305, 0.00292, 0.00278, 0.00247, 0.00233, 
       0.00204, 0.00187, 0.00181, 0.00160, 0.00139, 0.00157, 0.00145, 0.00124, 0.00114, 0.00094, 0.00084, 0.00072, 0.00048, 
       0.00045, 0.00038, 0.00048, 0.00012, 0.00005, -0.00006, -0.00027, -0.00034, -0.00031, -0.00053, -0.00066, -0.00064, 
       -0.00074, -0.00062, -0.00083, -0.00081, -0.00095, -0.00093, -0.00098, -0.00102, -0.00111, -0.00122, -0.00109, -0.00127, 
       -0.00144, -0.0014, -0.00138, -0.00148, -0.00148, -0.00155, -0.00168, -0.00177, -0.00163, -0.00172, -0.0017, -0.00189, 
       -0.00172, -0.00192, -0.00199, -0.002, -0.00194, -0.00204, -0.00202, -0.00212, -0.0021, -0.00209, -0.00223, -0.00228, 
       -0.00216, -0.00227, -0.00232, -0.00213]
...
#make a matrix for the Prime parameters
wav, it = 91, 7

Znot_prime = [[0 for x in range(wav)] for y in range(it)]
Mu1_prime  = [[0 for x in range(wav)] for y in range(it)]
Mu2_prime  = [[0 for x in range(wav)] for y in range(it)]

#Znot_prime = numpy.zeros((6,91))
#Mu1_prime  = numpy.zeros((6,91))
#Mu2_prime  = numpy.zeros((6,91))
...
for i in range(len(Waves)):
    ...
    #print("Mu2 at %d = %d" % i, Mu2_prime[0][i])
    #Znot[i] = (t6*t10*(LDR_Mueff6[i]-LDR_Mueff10[i]))/(2*((LDR_Mueff6[i]*t6-LDR_Mueff10[i]*t10+LDR_Mueff4[i]*(t10-t6))));
    #Mu1[i] = LDR_Mueff4[i]
    
    #Mu2_6  = (Mueff6[i]*t6 - 2*Znot[i]*Mu1[i])/(t6 - 2*Znot[i]) 
    #Mu2_10 = (Mueff10[i]*t10 - 2*Znot[i]*Mu1[i])/(t10 - 2*Znot[i])
    #Mu2[i] = numpy.average(Mu2_6, Mu2_10)
    
    #Mu2[i] = (LDR_Mueff6[i]*t6-LDR_Mueff10[i]*t10)/(t6-t10);
    #Mu2_prime[0][i] = Mu2[i]
...
for j in range (len(Iterations)):
    ...
    for i in range(len(Waves)):
        ...
        if j == 0: #Znot_prime[0] | Mu1, Mu2_prime[0]
            ...
            Znot_prime[j][i] = numpy.average([Znot_4, Znot_6, Znot_10])
            ...
            Mu2_prime[j][i] = numpy.average([Mu2_4, Mu2_6, Mu2_10])
            ...
            Mu1_prime[j][i] = numpy.average([Mu1_4, Mu1_6, Mu1_10])
            
        elif j == 3: #Znot_prime[3] | Mu1_prime[2], Mu2

            #print("Mu1_prime[2][i] is %.6f" % Mu1_prime[j-1][i])
            #print("Mu2[i] is %.6f" % Mu2[i])
            #print("Mueff4[i] is %.6f" % Mueff4[i])
        ...
        elif j == 6: #Znot_prime[6] | Mu1_prime[5], [0.5(Mu2_prime[4] + Mu2)] = Mu2_prime[6]

            Mu2_prime[j][i] = numpy.average([Mu2_prime[j-2][i], Mu2[i]])
            Znot_4  =  ((Mueff4[i]-Mu2_prime[j][i])*t4)/(2*(Mu1_prime[j-1][i]-Mu2_prime[j][i]))
            Znot_6  =  ((Mueff6[i]-Mu2_prime[j][i])*t6)/(2*(Mu1_prime[j-1][i]-Mu2_prime[j][i]))
            Znot_10 =  ((Mueff10[i]-Mu2_prime[j][i])*t10)/(2*(Mu1_prime[j-1][i]-Mu2_prime[j][i]))
...
for j in range (len(Iterations)):
    ...
    for i in range(len(Waves)):
        ...
        print("%.6f \t\t %.6f \t\t %.6f \t\t %.6f" % (Waves[i], Mu1_prime[j][i], Mu2_prime[j][i], Znot_prime[j][i]))
