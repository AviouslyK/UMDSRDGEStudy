...
for j in range (len(Iterations)):
    ...
    for i in range(len(Waves)):
        ...
        if j == 0:
            Mu2c = ((t1*c[i])-(2*ZnotsIT0[i]*a[i]))/(t1-(2*ZnotsIT0[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT0[i]*a[i]))/(t3-(2*ZnotsIT0[i]));
        ...
        if j == 1:
            Mu2c = ((t1*c[i])-(2*ZnotsIT1[i]*a[i]))/(t1-(2*ZnotsIT1[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT1[i]*a[i]))/(t3-(2*ZnotsIT1[i]));
        ...
        if j == 2:
            Mu2c = ((t1*c[i])-(2*ZnotsIT2[i]*a[i]))/(t1-(2*ZnotsIT2[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT2[i]*a[i]))/(t3-(2*ZnotsIT2[i]));
        ...
        if j == 3:
            Mu2c = ((t1*c[i])-(2*ZnotsIT3[i]*a[i]))/(t1-(2*ZnotsIT3[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT3[i]*a[i]))/(t3-(2*ZnotsIT3[i]));
        ...
        if j == 4:
            Mu2c = ((t1*c[i])-(2*ZnotsIT4[i]*a[i]))/(t1-(2*ZnotsIT4[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT4[i]*a[i]))/(t3-(2*ZnotsIT4[i]));
        ...
        if j == 5:
            Mu2c = ((t1*c[i])-(2*ZnotsIT5[i]*a[i]))/(t1-(2*ZnotsIT5[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT5[i]*a[i]))/(t3-(2*ZnotsIT5[i]));
        ...
        if j == 6:
            Mu2c = ((t1*c[i])-(2*ZnotsIT6[i]*a[i]))/(t1-(2*ZnotsIT6[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT6[i]*a[i]))/(t3-(2*ZnotsIT6[i]));
        ...
        if j == 7:
            Mu2c = ((t1*c[i])-(2*ZnotsIT7[i]*a[i]))/(t1-(2*ZnotsIT7[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT7[i]*a[i]))/(t3-(2*ZnotsIT7[i]));
        ...
        if j == 8:
            Mu2c = ((t1*c[i])-(2*ZnotsIT8[i]*a[i]))/(t1-(2*ZnotsIT8[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT8[i]*a[i]))/(t3-(2*ZnotsIT8[i]));
        ...
        if j == 9:
            Mu2c = ((t1*c[i])-(2*ZnotsIT9[i]*a[i]))/(t1-(2*ZnotsIT9[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT9[i]*a[i]))/(t3-(2*ZnotsIT9[i]));
        ...
        if j == 10:
            Mu2c = ((t1*c[i])-(2*ZnotsIT10[i]*a[i]))/(t1-(2*ZnotsIT10[i]));

            Mu2b = ((t3*b[i])-(2*ZnotsIT10[i]*a[i]))/(t3-(2*ZnotsIT10[i]));
